...
function done()
{
    //localStorage.setItem("for_4", "OK");      //have to do it in the out4in.xyz domain !!!
    alert("כל הכבוד סיימתם את המשימה ! \nהקוד face134 הוסף אוטומטית למאגר (סטטוסים הקודים - בדף הבית).");
    document.location.href = "http://out4in.xyz/EscapeZone_Short/Station_4/index.html?finish=yes";
}
