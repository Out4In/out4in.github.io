...
function done()
{
    //localStorage.setItem("for_5", "OK");          //have to do this in the out4in.xyz domain !!!
    alert("כל הכבוד סיימתם את המשימה ! \nהקוד puzz576 הוסף אוטומטית למאגר (סטטוסים הקודים - בדף הבית).");
    document.location.href = "http://out4in.xyz/EscapeZone_Short/Station_5/index.html?finish=yes";
}
